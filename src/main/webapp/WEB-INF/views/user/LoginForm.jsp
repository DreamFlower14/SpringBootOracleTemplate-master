                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <form name="f" method="post" action="getUserLoginCheck" onsubmit="return doLoginUserCheck(this);">
                                    <div class="form-outline form-white mb-4">
                                        <input type="text" name="user_id" placeholder="ID" class="form-control form-control-lg"/>
                                    </div>
