...
public class WeatherService implements IWeatherService {
    ...
    @Override
    public WeatherDTO getWeather(WeatherDTO wDTO) throws Exception {
        log.info(this.getClass().getName()+".getWeather Start!!!");

        String lat = CmmUtil.nvl(wDTO.getLat());
        String lon = CmmUtil.nvl(wDTO.getLon());

        String apiParam = "?lon="+lon+"&lat="+lat+"&appid="+apikey+"&units=metric";
